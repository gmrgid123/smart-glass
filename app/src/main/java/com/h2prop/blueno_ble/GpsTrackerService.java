...
public class GpsTrackerService extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location)
    {
        ...
        //BluetoothChatFragment.lat = location.getLatitude();
        //BluetoothChatFragment.lon = location.getLongitude();
        MainActivity.lat = getLatitude();
        MainActivity.lon = getLongitude();
        // 위치 변동시 실행함수
    }
